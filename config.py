...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/king-1-9/AMusic",
)
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "𝚂𝚄𝙾𝚁𝙲𝙴 Z3EIM ")
CHANNEL_LINK = getenv("CHANNEL_LINK", "SYS90k")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/SYS90k")
